...
10.2022 - 12.2022. **Учебный проект в YLab**, стажировка
**Название проекта:** *Сервис оценки бизнес-идей* ([ссылка](https://git.yiilab.com/java_interns/business-ideas))
**Задача:** *разработать сервис оценки бизнес-идей путем их одобрения или отлконения посредством экспертных оценок (голосование).<br> 
Идеи публикуются авторами, авторы могут ставить лайки/дизлайки идеям других авторов. Эксперты помимо возможностей авторов имеют<br>
возможность отдавать голос за идею или против идеи. Идея приобретает статусы "одобрено/отклонено" при достижении количеством голосов<br>
заданного ценза (порога)*
...
Liquibase, PostgreSQL, KeyCloak, JWT, Minio, Kafka, JUnit, Testcontainers, Docker*
**Чем занимался на проекте:**
08.2022 - 10.2022. **Учебный проект в YLab**, курс-интенсив "Погружение в Java"<br>
**Название проекта:** *Сервис регистрации читателей библиотеки* ([ссылка](https://github.com/borodatyidrug/ylab-spring))
...
такие технологии, как Spring Data, MVC, Test, Actuator, OpenAPI/Swagger, Liquibase*
**Используемые технологии:** *Spring Boot Data, MVC, Test, Actuator, OpenAPI/Swagger, Liquibase*
**Результаты:** *В ходе реализации проекта успешно применены такие подходы и технологии, как in-memory storage, JDBC, JPA и ORM, REST, healthcheck, OpenAPI/Swagger, модульное и интеграционное тестирование, тест-контейнеры и т.д.*
