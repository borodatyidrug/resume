...
* Создание приложений на SpringBoot
* Начальный опыт работы в команде в рамках учебного проекта на стажировке (в процессе)
#### Инструменты:
* Java
* GIT
* GitHub
...
* Quartz
* Jsoup, STaX
* Spring Data, MVC, Test, Actuator, OpenAPI
* Liquibase
* PostgreSQL
